...
class CustomGrid:
    ...
    def __eq__(self, other: CustomGrid) -> bool:
        grid1 = self.encode()
        grid2 = other.encode()
        return np.array_equal(grid2, grid1)

    def __ne__(self, other: CustomGrid) -> bool:
        return not self == other

    def copy(self) -> CustomGrid:
    ...
    def rotate_left(self) -> CustomGrid:
        """
    ...
    def slice(self, topX: int, topY: int, width: int, height: int) -> CustomGrid:
        """
    ...
    def render_tile(
        ...
        if agent_dir is not None:
            ...
            crc_fn = point_in_circle(
                0.5, 0.5,
                0.4,
            )

            fill_coords(img, crc_fn, (255, 0, 0))
    ...
    @staticmethod
    def decode(array: np.ndarray) -> tuple[CustomGrid, np.ndarray]:
        """
